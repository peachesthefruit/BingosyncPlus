...
chrome.runtime.sendMessage({type: 'request', content: 'listsA'}).then(lists => handleLists(lists, 'a'));
chrome.runtime.sendMessage({type: 'request', content: 'listsB'}).then(lists => handleLists(lists, 'b'));
